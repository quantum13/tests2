...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('main_test', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now()),
                      keep_default=False)

        # Adding field 'Test.author'
        db.add_column('main_test', 'author',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], default=User.objects.filter(is_superuser=True)[0].pk),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Test.created'
        db.delete_column('main_test', 'created')

        # Deleting field 'Test.author'
        db.delete_column('main_test', 'author_id')
    ...
    models = {
        ...
        'main.test': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 12, 0, 0)'}),
