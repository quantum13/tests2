...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(PROJECT_ROOT, "tests2.sqlite"), # Or path to database file if using sqlite3.
...
SECRET_KEY = '0hdisj1v=-px@j9jch%y!pi6)wa4k3qm!wcqh%rjz5%4!@9m60'
...
VK_APP_ID = '3074954'
VK_API_SECRET = '2lrabL2QZl5r92rRqx82'
